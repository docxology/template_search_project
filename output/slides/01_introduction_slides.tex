...
\breakseq{[@peng2011reproducible]}. Manual literature curation is a well-known
...
solution. The pipeline outputs are summarised in \breakseq{[@sec:methodology]}
(overview figure at the start of that section):
