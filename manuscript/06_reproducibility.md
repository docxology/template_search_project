...
mv projects/template_search_project/output projects/template_search_project/output_first
uv run python projects/template_search_project/scripts/run_search_pipeline.py
diff -ru \
    projects/template_search_project/output_first/corpus.json \
    projects/template_search_project/output/corpus.json
```
